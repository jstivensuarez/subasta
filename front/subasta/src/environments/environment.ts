...
export const environment = {
  ...
  endpointLogin: 'http://localhost:3002/api/login',
  endpointLote: 'http://localhost:3002/api/lotes',
  endpointCategoria: 'http://localhost:3002/api/categorias',
  endpointRaza: 'http://localhost:3002/api/razas',
  endpointSexo: 'http://localhost:3002/api/sexos',
  ...
  imageUrl: 'http://localhost:3002/images/',
};
